$(function () {
  ...
  $(".btn-post").click(function () {
    var last_feed = $(".stream ul:first-child").attr("feed-id");
  ...
  $("div.stream").on("click", ".like", function () {
  ...
  $("div.stream").on("keydown", ".comments input[name='post']", function (evt) {
    var keyCode = evt.which?evt.which:evt.keyCode;
    if (keyCode == 13) {
  ...
  $("div.stream").on("click", ".remove-feed", function () {
    var li = $(this).closest("li");
    var feed = $(li).attr("feed-id");
    var csrf = $(li).attr("csrf");
    $.ajax({
  ...
  $.fn.count = function (limit) {
      ...
      if (length <= 0) {
        ...
        $(".help-count")[0].style.color = "red";
      }
      else {
        $(".form-group", form).removeClass("has-error");
        $(".help-count")[0].style.color = "";
      }
